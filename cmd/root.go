...
var rootCmd = &cobra.Command{
	Use:   "crypto",
	Short: "A CLI tool for querying cryptocurrency prices",
	Long: `Crypto Price CLI is a command-line tool that allows you to quickly 
query cryptocurrency prices from various exchanges.

Examples:
  crypto price btc
  crypto price eth usd
  crypto list
  crypto compare btc eth`,
}
